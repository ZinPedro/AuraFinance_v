...
function Card({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ background: "#ffffff", borderRadius: "16px", padding: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)", display: "flex", flexDirection: "column", gap: "12px" }}>
      {children}
    </div>
  );
}
    ...
    <>
      ...
      <div className="af-obj-kpis">
        <Card>
          ...
          <span style={{ fontSize: "14px", color: "#6b7280" }}>Progresso Total</span>
        ...
        <Card>
          ...
          <span style={{ fontSize: "14px", color: "#6b7280" }}>Total Economizado</span>
        ...
        <Card>
          ...
          <span style={{ fontSize: "14px", color: "#6b7280" }}>Objetivos Ativos</span>
          <div style={{ fontSize: "28px", fontWeight: 600 }}>{ativos}</div>
          <span style={{ fontSize: "13px", color: "#6b7280" }}>
            {proximoDaConclusao > 0
              ? `${proximoDaConclusao} próximo${proximoDaConclusao > 1 ? "s" : ""} da conclusão`
              : "Nenhum próximo da conclusão"}
          </span>
        </Card>
      </div>
    </>
